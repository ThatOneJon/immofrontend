    ...
    return(
        <Suspense fallback={<Loading />}>
            ...
            <div className="flex flex-col lg:flex-row flex-wrap justify-evenly ">
                {listJsons.map(l => { 
                return(
                    <div key={l.title} className="lg:w-1/4 bg-slate-300 my-3 mx-1 rounded border-slate-900 border-2 text-center">
                        ...
                        <button className="bg-slate-900 p-3 rounded text-white hover:shadow-black hover:shadow-lg mb-5 lg:w-1/4">Show interest!</button>
                        <Remove id={l._id} />
                    </div>
                )})
            }
